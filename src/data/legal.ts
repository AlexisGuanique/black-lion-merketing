...
export const termsSections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      `${siteConfig.brand} provides branding, marketing consulting, content creation, website development, social media management, and digital growth services for small businesses. ${siteConfig.disclaimer}`,
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "All listed services are one-time payments unless otherwise stated at checkout. Payment methods and fees are shown on each service page and processed through Square.",
    ],
  },
  {
...
export const refundSections: LegalSection[] = [
  ...
  {
    title: "3. Custom Projects & Packages",
    paragraphs: [
      "Deposits for custom projects and service packages may be non-refundable after work has begun, as stated in your service agreement or at checkout.",
    ],
  },
  {
