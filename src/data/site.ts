...
export const homeContent = {
  ...
  customerSuccess: {
    ...
    body: "Our website and service packages are designed to present Lion Business as a legitimate, professional marketing business with clear offerings, secure checkout, and transparent policies.",
  },
...
export const aboutContent = {
  ...
  story: {
    ...
    items: [
      "Lion Business was founded to help small businesses improve their online presence with professional marketing services that are clear, credible, and accessible.",
